      ...
      if (eventData.location) {
        try {
          ...
          if (coords) {
            ...
            toast.success('Location mapped successfully!', { id: loadingToast });
          } else {
            toast.error('Could not find exact location, but event saved', { id: loadingToast });
          }
        } catch (geocodeError) {
          console.error('Geocoding error:', geocodeError);
          // Continue saving even if geocoding fails
          toast.error('Location mapping failed, but continuing...', { id: loadingToast });
        }
      }
