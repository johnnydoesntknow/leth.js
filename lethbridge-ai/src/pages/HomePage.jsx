                  ...
                  {messages.map((message, index) => (
                    ...
                    >
                      ...
                      >
                        ...
                        {/* Display Events - ENHANCED WITH IMAGES AND CLICK */}
                        ...
                        {/* Display Community Listings - ENHANCED WITH IMAGES AND CLICK */}
                          ...
                          <div className="mt-4 space-y-3">
                            ...
                            {message.personalListings.map((listing) => (
                              <div
                                key={listing.id}
                                onClick={() => {
                                  // Navigate to community page with listing details
                                  if (listing.listing_type === 'event') {
                                    // For event-type listings, could open a modal or navigate
                        ...
                        {/* Display Marketplace Items - ENHANCED */}
          ...
          <div className="bg-gray-50 rounded-xl p-4">
            ...
            <div className="space-y-2">
              ...
              <Link
                ...
                className="flex items-center justify-between p-2 hover:bg-white rounded-lg transition-colors group"
              >
                <span className="text-sm text-gray-700 group-hover:text-blue-600">Marketplace</span>
                <ChevronRightIcon className="w-4 h-4 text-gray-400 group-hover:text-blue-600" />
              </Link>
              <Link
                to="/community"
