  ...
  const loadSubscriptionTiers = async () => {
    try {
      ...
      setSubscriptionTiers(tiers || [
        // Fallback tiers if database is empty
        {
          id: 1,
          name: 'starter',
          price: 0,
          ...
          features: JSON.stringify(['Basic analytics', 'Standard listing placement'])
        },
        {
          id: 2,
          name: 'professional',
          ...
          ai_agent_enabled: false,
          features: JSON.stringify(['Priority placement', 'Advanced analytics', 'Featured badge'])
        },
        {
          id: 3,
          name: 'enterprise',
          ...
          ai_agent_monthly_queries: 1000,
          features: JSON.stringify(['Premium placement', 'AI Assistant', 'Custom branding', 'Dedicated support'])
        }
      ]);
    } catch (error) {
          ...
          {activeTab === 'ai-agent' && (
            currentTier.ai_agent_enabled ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-4">Upgrade to Enterprise plan to enable AI features</p>
                <button 
...
function SettingsTab({ business, currentTier, subscriptionTiers, onUpdate }) {
  const [formData, setFormData] = useState({
    name: business.name,
  ...
  const handleUpgradePlan = (tier) => {
    ...
    toast.info(`Upgrade to ${tier.name} plan coming soon! Contact support@lethbridgeai.com for early access.`);
    
    // You could also open a modal or redirect to a payment page
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600 mb-6">
            Upgrade your plan to get more visibility and features for your business
          </p>
          ...
          <div className="space-y-4">
            ...
            <div className={`p-6 border-2 rounded-lg transition-all relative ${
              ...
              {currentTier.name !== 'professional' && (
                <button
                  onClick={() => handleUpgradePlan({ name: 'professional', price: 29 })}
                  className="w-full px-4 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all"
                >
            ...
            <div className={`p-6 border-2 rounded-lg transition-all ${
              ...
              <div className="flex justify-between items-start mb-3">
                <div>
                  <h5 className="font-bold text-lg text-gray-900">Enterprise</h5>
                  {currentTier.name === 'enterprise' && (
                    <span className="inline-block mt-1 px-2 py-1 bg-blue-600 text-white text-xs font-semibold rounded">
                      CURRENT PLAN
                    </span>
              ...
              <ul className="space-y-2 text-sm text-gray-600 mb-4">
                ...
                <li className="flex items-start">
                  <CheckIcon className="w-5 h-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                  <span className="font-semibold text-gray-900">AI Business Assistant (1000 queries/mo)</span>
                </li>
                <li className="flex items-start">
                  <CheckIcon className="w-5 h-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
              ...
              {currentTier.name !== 'enterprise' && (
                <button
                  onClick={() => handleUpgradePlan({ name: 'enterprise', price: 99 })}
