...
function EventModal({ event, business, currentTier, onClose, onSave }) {
  ...
  setEnhancing(true);
  try {
    // Use the new enhanceDescription function with 'business' type
    const enhancedText = await aiService.enhanceDescription(formData.description, 'business');
            ...
            <div className="mt-2 flex justify-between items-center">
              ...
              {formData.description && formData.description.length > 0 && formData.description.length < 10 && (
                <p className="text-xs text-amber-600">
                  ✨ Add more detail (10+ chars) to enable AI
                </p>
              )}
            </div>
            {enhancing && (
              <div className="mt-2 flex items-center gap-2 text-sm text-purple-600">
                ...
                AI is crafting compelling event copy...
              </div>
            )}
          </div>
